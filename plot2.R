...
Baltimore_yr_sum <- tapply(Baltimore_data$Emissions, Baltimore_data$year, sum)

png("plot2.png")
plot(names(Baltimore_yr_sum), Baltimore_yr_sum, type="l", xlab = "Year", ylab = "Total of Emmissions", main = "Baltimore PM2.5 emissions per Year", col.main = "purple")
